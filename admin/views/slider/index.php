        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="index.php?option=slider&cat=insert" class="btn btn-sm btn-success"><i
                            class="fas fa-plus"></i>Thêm</i></a>
                    <a href="index.php?option=slider&cat=trash" class="btn btn-sm btn-danger"><i
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php endif;?>
                                <a href="index.php?option=slider&cat=update&id=<?php echo $row['id'];?>"
