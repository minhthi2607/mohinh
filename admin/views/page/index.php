<?php
$post =loadModel('post');
$list=$post->post_list(['status' => 'index','type'=>'page','sort'=>['orderby'=>'created_at','order'=>'DESC']]);
?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="index.php?option=page&cat=insert" class="btn btn-sm btn-success"><i
                ...
                <table class="table table-bordered" id="myTable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Tiêu đề trang đơn</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php endif;?>
                                <a href="index.php?option=page&cat=update&id=<?php echo $row['id'];?>"
