            ...
            <div class="col-md-6">
                ...
                <form action="index.php?option=cart&cat=buy" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="fullname" type="text" readonly
                            value="<?php echo $row_user['fullname']; ?>" />
                    </div>
                    <div class="form-group">
                        <label>Điện thoại</label>
                        <input class="form-control" name="phone" type="text" readonly
                    ...
                    <div class="form-group">
                        <label>Địa chỉ</label>
                        <input class="form-control" name="address" type="text" readonly
            ...
            <div class="col-md-6">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><img class="img-fluid" src="public/images/<?php echo $cart_row['img']; ?>"
                                class="card-img-top" alt="<?php echo $cart_row['slug']; ?>"></td>
