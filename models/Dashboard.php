<?php
//Truy vấn dữ Dữ liệu bang dashboard
class Dashboard extends Database
{
    public function __construct()
    {
        parent::__construct();
        $this->table = $this->TableName('dashboard');
    }
    function dashboard_row($args = [])
    {
        $strWhere = "";
        if ($args != null) {
    ...
    function dashboard_insert($data)
    {
        $strf = "";
        $strv = "";
        foreach ($data as $f => $v) {
    ...
    function dashboard_update($data, $id)
    {
        $strset = "";
        foreach ($data as $f => $v) {
            $strset .= $f . "='$v', ";
